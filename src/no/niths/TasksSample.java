...
public class TasksSample extends ListActivity {
        ...
        Tasks.builder(transport, new JacksonFactory()).setApplicationName("Google-TasksSample/1.0")
            ...
            .setJsonHttpRequestInitializer(new JsonHttpRequestInitializer() {
              ...
              public void initialize(JsonHttpRequest request) throws IOException {
                ...
                tasksRequest.setKey("1064171706637.apps.googleusercontent.com");
              }
            }).build();
          ...
          public void run(AccountManagerFuture<Bundle> future) {
            try {
              ...
              if (bundle.containsKey(AccountManager.KEY_INTENT)) {
                ...
                String tkn = accessProtectedResource.getAccessToken();
                Log.i("token", "the token is: " + tkn);
                Log.i("email ", "email:" + account.name);
  ...
  void onAuthToken() {
      ...
      HttpGet get = new HttpGet("http://10.0.2.2:8080/niths/foo/qux");
      
      try {
        org.apache.http.HttpResponse response = client.execute(get);
    } catch (ClientProtocolException el) {
        Log.e("client p e", el.getMessage());
